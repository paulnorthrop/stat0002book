...
The plot in Figure \@ref(fig:shuttle3) gives you an idea of one of the analyses that @shuttle carried out.  The sample proportions of O-rings showing thermal distress (number of O-rings showing distress divided by 6) are plotted against temperature.  Also plotted is a smooth curve fitted to these data. The article [Chapter 1: The Challenger Space Shuttle Disaster](https://paulnorthrop.github.io/stat0002/articles/stat0002-ch1a-shuttle-vignette.html) describes the model that defines this curve and the statistical methods used to estimate the model's unknown parameters. [This analysis is beyond scope of STAT0002/0003.  You may study this type of model in STAT0023.]
