...
**Definition**. Let $\mu_X=\text{E}(X)$ and $\mu_Y=\text{E}(Y)$. The **covariance** $\text{cov}(X,Y)$ between two random variables $X$ and $Y$ is given by
$$
...
```{r echo=FALSE, corr8, fig.show='hold', fig.cap='Samples from distributions with correlations $\\rho=0$ (2 of them), $\\rho=\\pm 0.3, \\rho=\\pm 0.7$ and $\\rho=\\pm 1$.', out.width = '70%'}
