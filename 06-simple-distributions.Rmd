...
*  Parameter: $p \in [0,1]$.
*  $\text{E}(X)=p$, $\text{var}(X)=p\,(1-p)$. (**Exercise**)
...
*  $\text{E}(Y)=n\,p$, $\text{var}(Y)=n\,p\,(1-p)$. (**Exercise**. Note that $Y=X_1 + \cdots + X_n$, where $X_i, i=1, \ldots, n$ are independent Bernoulli($p$) random variables.)
...
*  Parameter: $p \in (0,1]$.
*  $\text{E}(W)=\displaystyle\frac1p$, $\text{var}(W)=\displaystyle\frac{1-p}{p^2}$. (**Exercise**)
...
### Summary of the $\text{N}(\mu,\sigma^2)$ distribution
