...
```{r echo=FALSE, hollowdown,  fig.show='hold', fig.cap='A curve in which $x$ is bulging down and $y$ is bulging up compared to an imaginary straight line drawn between the ends of the curve.'}
