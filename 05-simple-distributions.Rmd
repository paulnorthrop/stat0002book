...
```{r echo=FALSE, babyexpplots, fig.show='hold', fig.cap='Histogram (left) and boxplot (right) of the sample times between births.', out.width = '50%'}
...
```{r echo=FALSE, babynormalplots, fig.show='hold', fig.cap='Histogram (left) and boxplot (right) of the sample birth weights.', out.width = '50%'}
