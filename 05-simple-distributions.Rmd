...
```{r echo=FALSE, babyexpplots, fig.show='hold', fig.cap='Histogram (left) and boxplot (right) of the sample times between births.'}
include_cropped_graphics("images/baby_exp_hist.png")
include_cropped_graphics("images/baby_exp_box.png")
```
